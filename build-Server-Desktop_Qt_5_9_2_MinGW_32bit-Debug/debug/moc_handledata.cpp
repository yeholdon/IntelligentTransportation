...
QT_MOC_LITERAL(1, 11, 22), // "receiverDeviceDataSlot"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 8), // "DataInfo"
QT_MOC_LITERAL(4, 44, 4) // "info"

    },
    "HandleData\0receiverDeviceDataSlot\0\0"
    "DataInfo\0info"
};
...
void HandleData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HandleData *_t = static_cast<HandleData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiverDeviceDataSlot((*reinterpret_cast< DataInfo(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject HandleData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HandleData.data,
      qt_meta_data_HandleData,  qt_static_metacall, nullptr, nullptr}
};
